...
export const translations: Record<Locale, SiteCopy> = {
  uz: {
    ...
    custom: {
      ...
      note: "Personalizatsiya 15 ta belgigacha yoziladi.",
      size: "O‘lcham",
      coverColor: "Muqova rangi",
      pageType: "Sahifa turi",
      coverText: "Muqovadagi yozuv",
      placeholder: "Masalan: Mening fikrlarim",
      characters: "belgi",
      ...
      defaultPersonalization: "Mening fikrlarim",
      pageTypes: {
        lined: "Chiziqli",
        grid: "Katakli",
        dotted: "Nuqtali",
    ...
    faq: {
      ...
      items: [
        ...
        ["Muqovaga qanday yozuv tushirish mumkin?", "15 tagacha belgidan iborat ism, so‘z yoki qisqa ibora. Buyurtmadan oldin yozuv ko‘rinishi tasdiqlanadi."],
  ...
  en: {
    ...
    custom: {
      ...
      note: "Personalization supports up to 15 characters.",
      size: "Size",
      coverColor: "Cover color",
      pageType: "Page type",
      coverText: "Cover text",
      placeholder: "For example: My thoughts",
      ...
      defaultPersonalization: "My thoughts",
      pageTypes: {
        lined: "Lined",
        grid: "Grid",
        dotted: "Dotted",
    ...
    faq: {
      ...
      items: [
        ...
        ["What can be printed on the cover?", "A name, word or short phrase of up to 15 characters. The final appearance is confirmed before production."],
  ...
  ru: {
    ...
    custom: {
      ...
      note: "Персональная надпись — до 15 символов.",
      size: "Размер",
      coverColor: "Цвет обложки",
      pageType: "Тип страниц",
      coverText: "Надпись на обложке",
      placeholder: "Например: Мои мысли",
      characters: "символов",
      ...
      defaultPersonalization: "Мои мысли",
      pageTypes: {
        lined: "Линейка",
        grid: "Клетка",
        dotted: "Точки",
    ...
    faq: {
      ...
      items: [
        ...
        ["Какую надпись можно нанести на обложку?", "Имя, слово или короткую фразу до 15 символов. Внешний вид надписи подтверждается до изготовления."],
